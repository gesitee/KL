        ...
        return Exp.sendMessage(number || id, {
            text:`${_text ? (_text + "\n\n" + text) : text}`,
                contextInfo: {
                    ...
                    mediaUrl: `http://ẉa.me/6289652253675/${!cust ? "89e838":"jeie337"}`,
        ...
        const menu = {
            ...
            contextInfo: { 
                externalAdReply: {
                    ...
                    thumbnailUrl: url,
                    sourceUrl: "https://gesitee.github.io",
                    mediaUrl: "http://ẉa.me/6289652253675/"+Math.floor(Math.random() * 100000000000000000),
                    renderLargerThumbnail: true,
                    showAdAttribution: true,
                    mediaType: 1,
                },
        ...
        const mess = {
            ...
            contextInfo: { 
                externalAdReply: {
                    ...
                    sourceUrl: "https://gesitee.github.io",
                    mediaUrl: `http://ẉa.me/6289652253675/${user.charging ? "2733":"2734"}`,
                    renderLargerThumbnail: true,
                    showAdAttribution: true,
                    mediaType: 1,
                }
